...
public class EmployeeRepositoryTest 
{
	...
	{
		EmployeeEntity employee = EmployeeEntity.builder().employeeFirstName("Barathi").employeeLastName("karunakaran")
				.employeeMobileNumber("8608967899").employeeEmail("barathi@gmail.com").employeeAddress("Chennai")
				.employeeBloodGroup("A1 -ve").employeeDesignation("Developer").employeeSalary("28,000").build();
